      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
		    ...
		    <div id="display-image">
                  ...
                  <label>Registration Start Date :<br></label><input type = "text" name = "regstart" class = "box" value = <?php echo $_SESSION['login_regstart']; ?> /><br /><br />
                  <label>Registration End Date :<br></label><input type = "text" name = "regend" class = "box" value = <?php echo $_SESSION['login_regend']; ?> /><br /><br />
                  <label>Estate Agent Name :<br></label><input type = "text" name = "estateagentname" class = "box" value = <?php echo $_SESSION['login_estateagentname']; ?> /><br /><br />
                  <label>Estate Agent License No :<br></label><input type = "text" name = "estateagentlicense" class = "box" value = <?php echo $_SESSION['login_estateagentlicense']; ?> /><br /><br />

                <strong>User Type:</strong><br>
				<input type='text' name='user_type' value=<?php echo $_SESSION['login_usertype']; ?> class = "box"/> <br /><br /><br />   
<button type=""submit" name="Submit" class = "btn">Profile Update</button>
