      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
		    ...
		    <div id="display-image">
                  ...
                  <label>Registration Start Date :<br></label><input type = "text" name = "id" class = "box" value = <?php echo $_SESSION['login_regstart']; ?> /><br /><br />
                  <label>Registration End Date :<br></label><input type = "text" name = "id" class = "box" value = <?php echo $_SESSION['login_regend']; ?> /><br /><br />
                  <label>Estate Agent Name :<br></label><input type = "text" name = "id" class = "box" value = <?php echo $_SESSION['login_estateagentname']; ?> /><br /><br />
                  <label>Estate Agent License No :<br></label><input type = "text" name = "id" class = "box" value = <?php echo $_SESSION['login_estateagentlicense']; ?> /><br /><br />

                <strong>User Type:</strong><br>
				<input type='text' name='user_type' value=<?php echo $_SESSION['login_usertype']; ?> class = "box"/> <br /><br /><br />   
<input type="button" class = "btn" onclick="window.location.href='update_profile_agent.php';" value ="Profile Update"/>

<input type="button" class = "btn" onclick="window.location.href='add_property_form.php';" value ="Add Property"/>
